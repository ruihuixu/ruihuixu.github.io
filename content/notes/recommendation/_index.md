...
| [OneRec-V2](OneRec-V2-Kuaishou.md) | 快手 | 2025 | Lazy Decoder-Only 架构，计算量减少 94% |

### 判别式推荐 (Discriminative Recommendation)

| 论文 | 机构 | 时间 | 核心贡献 |
|------|------|------|----------|
| [RankMixer](RankMixer-ByteDance.md) | 字节 | 2024 | 硬件感知精排架构，MFU 从 4.5%→45%，70 倍参数扩展 |
| [HyFormer](HyFormer-ByteDance.md) | 字节 | 2025 | 统一混合 Transformer，Query Decoding+Boosting 交替优化 |
| [TokenMixer-Large](TokenMixer-Large-ByteDance.md) | 字节 | 2025 | RankMixer 大规模演进，15B 参数，MFU 60% |
